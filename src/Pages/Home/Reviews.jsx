        ...
        <section className="reviews--section" id="Reviews">
            <div className="portfolio--container--box">
                <div className="portfolio--container">
                    <p className="sub--title">Reviews</p>
                    <h2 className="sections--heading"> Friends Feedback</h2>
                </div>
            </div>
            <div className="portfolio--section--container">
                {data?.reviews?.map((item,index) => {
                    return(
                    <div key={index} className="reviews--section--card">
                        <div className="reviews--section--card--review">
            ...
            <div className="reviews--section--card--author--detail">
                <img src={item.src} alt="Avatar" />
                <div>
                <p className="text-md reviews--author--name">
                    {item.author_name}
                </p>
                <p className="text-md reviews--author--designation">
